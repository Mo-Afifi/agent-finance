      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-4xl font-bold text-white">OpenClaw Pay</span>
          </div>
          ...
          <div className="space-y-4 border-t border-slate-700 pt-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">Protected with Google OAuth 2.0</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs">Monitor your agents in real-time</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Lock className="h-5 w-5 text-blue-400 mt-0.5" />
              <div>
                <h3 className="text-white font-medium text-sm">Your Data Only</h3>
                <p className="text-slate-400 text-xs">See only agents you own</p>
              </div>
            </div>
          </div>
        </div>
